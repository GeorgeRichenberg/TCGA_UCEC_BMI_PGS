...
merge_mutsig_covars <- merge_mutsig_covars %>%
  select(-pgs)
dim(merge_mutsig_covars)

### Run ZINB analysis:
sbs2_zinb <- zeroinfl(SBS2 ~ bmi_cat + age + ms_status + stage + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + Accuracy,
...
write.csv(sbs2_results, file = "act_bmi_pgs_four_cat_sbs2_zinb.csv")

sbs10a_zinb <- zeroinfl(SBS10a ~ bmi_cat + age + ms_status + stage + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + Accuracy,
                        data = merge_mutsig_covars, 
                        dist = "negbin")
...
write.csv(sbs10a_results, file = "act_bmi_pgs_four_cat_sbs10a_zinb.csv")

sbs10b_zinb <- zeroinfl(SBS10b ~ bmi_cat + age + ms_status + stage + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + Accuracy,
                        data = merge_mutsig_covars, 
                        dist = "negbin")
...
write.csv(sbs10b_results, file = "act_bmi_pgs_four_cat_sbs10b_zinb.csv")

sbs13_zinb <- zeroinfl(SBS13 ~ bmi_cat + age + ms_status + stage + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + Accuracy,
                       data = merge_mutsig_covars, 
                       dist = "negbin")
...
write.csv(sbs13_results, file = "act_bmi_pgs_four_cat_sbs13_zinb.csv")

sbs15_zinb <- zeroinfl(SBS15 ~ bmi_cat + age + ms_status + stage + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + Accuracy,
                       data = merge_mutsig_covars, 
                       dist = "negbin")
...
write.csv(sbs15_results, file = "act_bmi_pgs_four_cat_sbs15_zinb.csv")

sbs40_zinb <- zeroinfl(SBS40 ~ bmi_cat + age + ms_status + stage + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + Accuracy,
                       data = merge_mutsig_covars, 
                       dist = "negbin")
...
write.csv(sbs40_results, file = "act_bmi_pgs_four_cat_sbs40_zinb.csv")

sbs44_zinb <- zeroinfl(SBS44 ~ bmi_cat + age + stage + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + Accuracy,
                       data = merge_mutsig_covars, 
                       dist = "negbin") 
...
write.csv(sbs44_results, file = "act_bmi_pgs_four_cat_sbs44_zinb.csv")
...
sbs_all <- rbind(sbs2_results,  
                 ...
                 sbs40_results,
                 sbs44_results)
write.csv(sbs_all, file = "act_bmi_pgs_four_cat_sbs_zinb.csv")