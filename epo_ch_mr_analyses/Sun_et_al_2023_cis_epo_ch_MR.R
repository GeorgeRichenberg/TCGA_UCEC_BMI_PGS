...
### Load required data:
epo_overall <- vroom("Sun_et_al_2023_cis_epo_overall_harmonised.csv")
epo_dnmt3a <- vroom("Sun_et_al_2023_cis_epo_dnmt3a_harmonised.csv")
epo_tet2 <- vroom("Sun_et_al_2023_cis_epo_tet2_harmonised.csv")
...
epo_ch <- rbind(epo_overall_results_rs1617640, 
                ...
                epo_dnmt3a_results_rs11976235,
                epo_tet2_results_rs11976235)
write_csv(epo_ch, file = "Sun_epo_ch.csv")
